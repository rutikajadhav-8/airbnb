...
export default function PlaceGallery({place}){
            ...
            <div className="absolute inset-0 bg-white min-h-screen">
                <div className=" p-8 grid gap-4">
                    <div>
                        ...
                        <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-7 flex gap-1 py-2 px-4 rounded-2xl bg-gray-200 text-black shadow shadow-black">
    ...
    return(
      <div className="relative">
        ...
        <button onClick={() => setShowAllPhotos(true)} className=" flex gap-1 absolute bg-white bottom-2 right-2 py-2 px-4 rounded-2xl shadow-md shadow-gray-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
